...
export const Hero = () => {
    ...
    // If not mounted, render nothing or a placeholder to avoid hydration mismatch
    // But since this is a client component, we can just default to light/system without breaking
    // Actually, safely render with isDark false initially or check mounted
    if (!mounted) {
    ...
    return (
        <div className={`min-h-screen relative overflow-hidden transition-colors duration-300 ${isDark ? 'dark' : ''} bg-sky-100 dark:bg-slate-900 text-sky-950 dark:text-slate-100`}>
            <HaloBackground />
            ...
            {/* Hero */}
            {/* Hero */}
            <section className={`relative overflow-hidden px-6 pt-4 pb-8 md:py-20 bg-gradient-to-br from-sky-200/80 to-sky-100/90 dark:from-slate-800/95 dark:to-slate-900/90`}>
                ...
                <div className="flex flex-col gap-12 max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="hidden md:grid grid-cols-2 gap-12 items-center">
                        ...
                        <div className="text-left flex flex-col gap-8">
                            ...
                            <div className="text-xl text-sky-800 dark:text-slate-400">
                                <p className="mb-2">Pause blind practice.</p>
                    ...
                    <div className="block md:hidden">
                        ...
                        <div className="text-center mb-8">
                            <h1 className="text-[2.5rem] font-bold mb-2 leading-tight">
                                <span className="text-sky-950 dark:text-white">NEET</span>
                                <span className="text-emerald-600">Stand</span>
                            </h1>
                            <h2 className="text-[1.5rem] font-bold">The Right Stop for NEET Prep</h2>
                        </div>

                        {/* Rotating Triangle */}
                        <div className="-mb-44 mt-8">
                            <RotatingTriangle isDark={isDark} scale={0.65} />
                        </div>

                        {/* CTA and value prop */}
                        <div className="text-center -mt-16">
                            <div className="text-lg text-sky-800 dark:text-slate-400 mb-6 font-medium">
                                <p className="mb-2">Pause blind practice. Identify your mistakes.</p>
                                <p>Move forward with NCERT-focused precision.</p>
                            </div>
            ...
            {/* Problem */}
            <section className="py-16 px-6 bg-sky-100 dark:bg-slate-900 text-sky-950 dark:text-slate-100">
            ...
            {/* Features */}
            <section className="py-16 px-6 bg-sky-200 dark:bg-slate-800 text-sky-950 dark:text-slate-100">
                <div className="max-w-7xl mx-auto px-6">
